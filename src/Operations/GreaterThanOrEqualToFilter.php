...
class GreaterThanOrEqualToFilter extends FilterAbstract
{
    ...
    public function getAndSearch()
    {
        ...
        return $this->model->where($this->column, '>=', $this->condition->value[0]);
    }
    ...
    public function getOrSearch()
    {
        ...
        return $this->model->orWhere($this->column, '>=', $this->condition->value[0]);
    }
}
